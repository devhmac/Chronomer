...
export const Timer = ({ className }: { className?: string }) => {
	...
	return (
		<>
			...
			<div
				className={cn(
					"dark:bg-accent/25 min-w-full rounded-lg border p-6 shadow-md backdrop-blur-sm sm:min-w-140 dark:border-[rgba(255,255,255,0.3)] dark:backdrop-blur-none",
					className,
				)}
			>
				<div
					className={cn(
						...
						"relative z-10 overflow-hidden before:absolute before:top-0 before:left-0 before:-z-10 before:h-full before:w-full before:bg-linear-to-tr before:from-purple-500 before:to-purple-300 before:transition-opacity before:duration-300",
				...
				>
					...
					<div>
						<p className="overflow-clip text-7xl sm:text-9xl">{displayTimer}</p>
					</div>
					<div className="absolute right-0 bottom-2 left-0 mx-2 flex flex-row items-center justify-between align-middle">
