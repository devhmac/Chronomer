...
export const Timer = () => {
  ...
  return (
    <>
      ...
      <div className="bg-muted/1  w-1/3 min-w-full rounded-lg  border p-6 shadow-md backdrop-blur dark:border-[rgba(255,255,255,0.3)] dark:bg-accent/25 dark:backdrop-blur-none sm:min-w-[540px]">
